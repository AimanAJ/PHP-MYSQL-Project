        ...
        <div class="wrapper">
                ...
                <nav>
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li>
                                <div class="dropdown">
                                    <a class="dropbtn" id="navicon" href="registration/sign up.php"><img src="icons8-test-account-80 (1).png" width="70%" height="70%"></a>
                                    <div class="dropdown-content">
                                        <a class="adrop" href="registration/sign up.php">Register</a>
                                        <a  class="adrop" href="registration/login.php">Login</a>
            ...
            <section class="hero">
                <div class="hero-inner">
                  ...
                  <?php //  if(isset($_SESSION['user_id '])) echo "<p>HI".$_SESSION['user_name '];"</p>" ?>
